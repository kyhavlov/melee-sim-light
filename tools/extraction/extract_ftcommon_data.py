...
def main() -> None:
    ...
    out = {
        ...
        # DeadUpFall / HitCamera match-flow timers and hidden offset data:
        # refs/melee/src/melee/ft/ft_0D31.c::{ftCo_800D4580,ftCo_DeadUpFall_Anim,ftCo_DeadUpFall_Phys}
        "dead_up_fall_entry_hold_frames": int(max(0, _i32_be(buf, ft_common_abs + 0x524))),
        "dead_up_fall_lerp_frames": int(max(0, _i32_be(buf, ft_common_abs + 0x528))),
        "dead_up_fall_hitcamera_hold_frames": int(max(0, _i32_be(buf, ft_common_abs + 0x52C))),
        "dead_up_fall_phase3_frames": int(max(0, _i32_be(buf, ft_common_abs + 0x530))),
        "dead_up_fall_phase4_frames": int(max(0, _i32_be(buf, ft_common_abs + 0x534))),
        "dead_up_fall_lerp_start_x": float(_f32_be(buf, ft_common_abs + 0x538)),
        "dead_up_fall_lerp_start_y": float(_f32_be(buf, ft_common_abs + 0x53C)),
        "dead_up_fall_lerp_start_z": float(_f32_be(buf, ft_common_abs + 0x540)),
        "dead_up_fall_lerp_end_x": float(_f32_be(buf, ft_common_abs + 0x544)),
        "dead_up_fall_lerp_end_y": float(_f32_be(buf, ft_common_abs + 0x548)),
        "dead_up_fall_lerp_end_z": float(_f32_be(buf, ft_common_abs + 0x54C)),
        ...
        "dead_up_fall_ice_rot_speed": float(_f32_be(buf, ft_common_abs + 0x560)),
