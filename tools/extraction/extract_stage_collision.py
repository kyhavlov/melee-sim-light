...
def _randall_corner_positions() -> dict[int, tuple[float, float]]:
    ...
    # MSL_DATA_DIR/raw/GrSt.dat::ALDYakuAll stage-object animation
    return {
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        type=Path,
        default=None,
        help="optional path to SSBM.iso (extracts --stage into MSL_DATA_DIR/raw)",
    )
    ...
    if args.dat is None:
        ...
        local = raw_data_dir() / stage_dat_name
