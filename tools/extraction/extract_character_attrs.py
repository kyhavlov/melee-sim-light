...
PURIN_SPECIAL_ATTRS_LAYOUT: list[tuple[str, int, str]] = [
    ...
    ("puff_rollout_air_terminal_vel", 0x40, "f32"),
    ("puff_rollout_slope_lane_ground", 0x44, "f32"),
    ("puff_rollout_vel_clamp_a", 0x4C, "f32"),
    ("puff_rollout_vel_clamp_b", 0x50, "f32"),
    ("puff_rollout_slope_lane_air", 0x54, "f32"),
    ("puff_rollout_air_decel", 0x58, "f32"),
    ...
    ("puff_rollout_damage_scale", 0x84, "f32"),
    ("puff_rollout_hit_vel_x_mul", 0x88, "f32"),
    ("puff_rollout_hit_vel_y", 0x8C, "f32"),
    ("puff_rollout_end_vel_x_mul", 0x90, "f32"),
    ("puff_rollout_end_vel_y_mul", 0x94, "f32"),
    ("puff_rollout_release_roll_rate", 0x98, "f32"),
    ("puff_rollout_charge_init", 0xA0, "f32"),
    ("puff_rollout_charge_max", 0xA4, "f32"),
    ("puff_rollout_charge_rate", 0xA8, "f32"),
    ("puff_rollout_loop_roll_rate_deg", 0xAC, "f32"),
    ("puff_rollout_charge_decay", 0xB4, "f32"),
    ("puff_rollout_charge_min_rolling", 0xB8, "f32"),
    ("puff_rollout_roll_rate_scale", 0xBC, "f32"),
    ("puff_rollout_release_vel_scale", 0xC0, "f32"),
    ("puff_rollout_turn_accel", 0xC4, "f32"),
    ("puff_rollout_slope_influence", 0xC8, "f32"),
    ("puff_rollout_min_damage_speed", 0xCC, "f32"),
    ("puff_rollout_turn_exit_vel_ratio", 0xD0, "f32"),
    ("puff_rollout_wall_bounce_decay", 0xD4, "f32"),
    ("puff_rollout_landing_lag", 0xD8, "f32"),
