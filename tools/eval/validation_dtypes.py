...
# Native validation buffer NumPy dtypes.
...
SEED_DTYPE = np.dtype(
    [
        ...
        ("stage_fod_platform_deferred_velocity_f32", _arr("<f4", 2)),
        ("stage_fod_platform_deferred_velocity_valid_u8", _arr("u1", 2)),
        ("stage_fod_platform_hidden_return_timer_u16", _arr("<u2", 2)),
        ("stage_fod_platform_hidden_return_valid_u8", _arr("u1", 2)),
        ("stage_fod_platform_visible_choice_timer_u16", _arr("<u2", 2)),
        ("stage_fod_platform_visible_choice_valid_u8", _arr("u1", 2)),
        ("stage_fod_platform_visible_choice_rng_seed_u32", _arr("<u4", 2)),
        ...
        ("stage_yoshi_shyguy_spawn_rng_seed_u32", "<u4"),
        ("stage_yoshi_shyguy_spawn_rng_seed_valid_u8", "u1"),
        ("_pad_stage_yoshi_shyguy", "V3"),
        ...
        ("cliff_option_stick_latch_x8", _arr("u1", MAX_PLAYERS)),
        ...
        # Hidden Sheik Vanish travel timer (`mv.sk.specialhi.x0`).
        ...
        # Hidden Sheik Needle stored count (`fv.sk.x0`) and End shoot timer
        ...
        # that frame's pose compounds two blend passes (see api.h).
        ("common_fall_blend_reload_u8", _arr("u1", MAX_PLAYERS)),
        ...
        # tools/slippi/staling_history.py (derive) and validation buffer modules (wire).
