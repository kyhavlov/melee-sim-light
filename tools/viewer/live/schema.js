...
export const CHAR_GAMEWATCH = 24;
...
export const CHAR_PICHU = 23;
export const CHAR_KIRBY = 4;
...
export const SUPPORTED_CHARACTERS = Object.freeze([
  ...
  Object.freeze({ id: CHAR_GAMEWATCH, label: "Mr. Game & Watch" }),
  ...
  Object.freeze({ id: CHAR_PICHU, label: "Pichu" }),
  Object.freeze({ id: CHAR_KIRBY, label: "Kirby" }),
