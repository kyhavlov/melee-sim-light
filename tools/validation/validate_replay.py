...
DEFAULT_CHARACTERS = "Mewtwo,Game & Watch,Fox,Falco,Marth,Roy,Captain Falcon,Sheik,Zelda,Jigglypuff,Peach,Luigi,Mario,Dr. Mario,Samus,Ice Climbers,Pikachu,Pichu,Donkey Kong,Ganondorf,Yoshi,Bowser,Ness,Link,Young Link"
