...
BUILD = ROOT / "build" / "decomp_port"
NATIVE = BUILD / "validation" / "_msl_decomp_validate.so"
BINARY = BUILD / "phase1" / "melee-decomp-port"
TOOLCHAIN = BUILD / "ppc-toolchain" / "root"
...
def load_native() -> ModuleType:
    ...
    spec = importlib.util.spec_from_file_location("_msl_decomp_validate", NATIVE)
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Stream Slippi replays through the PPC32 decomp port."
    )
