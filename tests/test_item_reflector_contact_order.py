...
def _step_seed(seed: np.ndarray, *, p1_hitbox_clank: bool = False) -> np.void:
    import msl_binding
    ...
    try:
        ...
        if p1_hitbox_clank:
            ...
            msl_binding.debug_set_hitbox_flags(handle, 0, 1, 0, (1 << 14) | (1 << 11))
...
def test_item_hitcapsule_clank_precedes_shield_and_body_contact() -> None:
    ...
    out = _step_seed(seed, p1_hitbox_clank=True)
