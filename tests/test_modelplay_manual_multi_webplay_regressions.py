...
FIXTURE = "tests/fixtures/modelplay/manual_multi_webplay_locomotion_specialhi_prefix_0_2460.json"
...
def _load_fixture() -> dict[str, Any]:
    ...
    assert fixture["source_trace"] == "manual_repros/multi_webplay.json"
