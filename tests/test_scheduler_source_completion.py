...
def test_step_frame_phase_spine_matches_source_order() -> None:
    ...
    _assert_ordered(
        ...
        [
            ...
            "anim_timebase_update_pre_input_fighter",
            "fighter_pose_publish_animation_phase_fighter",
            "fighter_script_advance_fighter",
            "grab_attachment_refresh_xrotn_constraint_after_anim",
            "match_flow_update_post_anim_fighter",
            "timers_update_post_anim_fighter",
            "action_update_anim_callback_pre_input_fighter",
            "items_spawn_fighter_anim_callback",
            "items_blaster_gun_anim_phase",
            "items_finish_fighter_anim_phase",
        ],
    )
