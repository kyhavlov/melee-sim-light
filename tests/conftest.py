...
def _ensure_known_data_artifacts() -> None:
    expected = [
        (ROOT / "data" / "stages" / "bin" / "grnla.bin", b"MSLSTG01", 7),
        (ROOT / "data" / "stages" / "bin" / "grnba.bin", b"MSLSTG01", 7),
        (ROOT / "data" / "stages" / "bin" / "griz.bin", b"MSLSTG01", 7),
        (ROOT / "data" / "stages" / "bin" / "grps.bin", b"MSLSTG01", 7),
        (ROOT / "data" / "stages" / "bin" / "grst.bin", b"MSLSTG01", 7),
        (ROOT / "data" / "stages" / "bin" / "grop.bin", b"MSLSTG01", 7),
