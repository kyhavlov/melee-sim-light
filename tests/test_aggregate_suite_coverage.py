...
@pytest.mark.parametrize(
    "component_suite",
    ("aggregate_recent", "puff", "peach", "doubles_recent", "luigi", "marios", "samus", "pikachu", "icies", "dk", "ganon", "yoshi", "bowser", "ness", "links", "mewtwo_targeted", "gamewatch", "cpu_inputs", "legacy_arithmetic", "roy"),
)
