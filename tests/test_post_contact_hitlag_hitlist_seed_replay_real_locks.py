...
def test_attackhi4_post_contact_hitlag_seed_suppresses_same_window_rehit_rollout() -> None:
    ...
    ds_path = root / "replays/validation/aggregate_recent/MotionlessAggressiveJay.slpz"
...
def test_attackhi4_post_contact_hitlag_bridge_requires_body_source_proof() -> None:
    ...
    attacker_iid = int(ds.rows["seed_t"][record]["instance_id"][attacker])
    victim_hitstun = int(ds.rows["seed_t"][record]["hitstun"][victim])
