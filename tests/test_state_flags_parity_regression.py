...
@pytest.mark.parametrize(
    ...
    [
        ...
        _Case(
            ...
            seed_byte=0x80,
            ref_byte=0x80,
            note="grounded Squat -> DamageN2 carries live allow_interrupt through ProcessHit",
        ...
        _Case(
            ...
            seed_byte=0x80,
            ref_byte=0x80,
            note="later grounded Squat -> DamageN2 carries live allow_interrupt through ProcessHit",
            seed_action_id=0x0027,
            ref_action_id=0x004F,
            seed_hitlag=0,
            ref_hitlag=4,
