...
@pytest.mark.parametrize(
    ...
    [
        ...
        _ActionCase(f"{_BASE}/AttachedGoodNaturedGuanaco.msl", 2757, 1, 354, 354, 0, 354, 308),
        _ActionCase(f"{_BASE}/QuerulousGrandDinosaur.msl", 5549, 1, 354, 354, 0, 354, 308),
        _ActionCase(f"{_BASE}/TreasuredBackKangaroo.msl", 3206, 1, 354, 354, 0, 354, 308),
        # Category B lock: top unfiltered action_id cluster 38->88 should transition to DamageFall.
        _ActionCase(f"{_BASE}/AttachedGoodNaturedGuanaco.msl", 5663, 1, 88, 38, 1, 38, 29),
        _ActionCase(f"{_BASE}/QuerulousGrandDinosaur.msl", 711, 1, 88, 38, 1, 38, 29),
        _ActionCase(f"{_BASE}/TreasuredBackKangaroo.msl", 1751, 0, 88, 38, 1, 38, 29),
    ],
)
...
@pytest.mark.parametrize(
    "case",
    [
        _ActionFrameCase(f"{_BASE}/AttachedGoodNaturedGuanaco.msl", 334, 1),
        _ActionFrameCase(f"{_BASE}/GracefulAttachedTurtle.msl", 1382, 0),
        _ActionFrameCase(f"{_BASE}/QuerulousGrandDinosaur.msl", 2478, 1),
        _ActionFrameCase(f"{_BASE}/TreasuredBackKangaroo.msl", 1590, 0),
    ],
)
...
# - GracefulAttachedTurtle.msl rec=3599 p=0
# - QuerulousGrandDinosaur.msl rec=2571 p=1
