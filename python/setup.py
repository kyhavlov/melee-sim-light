...
ext = Extension(
    ...
    sources=[
        ...
        str((ROOT / "src" / "special_msids.c").resolve()),
        ...
        str((ROOT / "src" / "item_article_params.c").resolve()),
        str((ROOT / "src" / "stage_item_params.c").resolve()),
        ...
        str((ROOT / "src" / "mpcoll_wall_ceil.c").resolve()),
        str((ROOT / "src" / "mpcoll_env.c").resolve()),
        ...
        str((ROOT / "src" / "staling_tables.c").resolve()),
        str((ROOT / "src" / "staling.c").resolve()),
        ...
        str((ROOT / "src" / "airborne_state_events_tables.c").resolve()),
