...
ext = Extension(
    ...
    sources=[
        ...
        str((ROOT / "src" / "pass_input.c").resolve()),
        str((ROOT / "src" / "pass_action.c").resolve()),
        str((ROOT / "src" / "pass_physics.c").resolve()),
        str((ROOT / "src" / "pass_stage_collision.c").resolve()),
        str((ROOT / "src" / "pass_hurtboxes.c").resolve()),
        str((ROOT / "src" / "pass_combat.c").resolve()),
        str((ROOT / "src" / "pass_items.c").resolve()),
    ],
