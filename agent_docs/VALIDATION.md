...
- [Kirby](validation/kirby_provenance.json): 26 corpus games (2026 Mainline
  ...
  missing-raw-cstick-asdi) plus 17 scripted headless Dolphin captures that
  swallow, fire, drop and lose every remaining copy ability and drive Kirby's
  own specials around Battlefield, with capture metadata, hashes, the
  recorder and the triaged exclusions.
