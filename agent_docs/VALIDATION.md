...
- [Roy](validation/roy_provenance.json): 27 corpus games (2026 Mainline
  Dolphin, Wii console captures from D20 Melee and Yeti Weekly, one console
  game mirrored over the network) with capture metadata and hashes.
