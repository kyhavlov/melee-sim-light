...
static inline uint8_t combat_attackairlw_strong_attacklw4_high_cap_sibling_rejects_body_contact(
    const MslBatch* batch, int bi, int attacker, uint8_t hb_id, int defender, size_t a_idx,
...
static inline uint8_t combat_specialhi_launch_hitbox_payload_is_authored(const MslBatch* batch,
                                                                         size_t hb_i,
                                                                         uint8_t hb_id) {
...
static inline uint8_t combat_attackairb_model_scale_cancellation_payload(
    uint8_t hb_id, float damage, uint16_t angle, uint16_t kbg, uint16_t wsk, uint16_t bkb) {
...
static inline uint8_t combat_guard_family_no_submotion_body_source_msid(const MslBatch* batch,
                                                                        size_t d_idx,
                                                                        uint16_t* out_msid) {
  if (batch == NULL) {
    return 0u;
...
static inline uint8_t combat_guardon_live_pose_source(const MslBatch* batch, size_t d_idx,
                                                      uint16_t* out_action, uint32_t* out_anim) {
...
static inline uint8_t combat_guard_family_no_submotion_body_source_pose(const MslBatch* batch,
                                                                        size_t d_idx,
                                                                        uint16_t* out_msid,
                                                                        float* out_frame) {
...
static inline uint8_t combat_guard_family_body_hurtcap_world(const MslBatch* batch, size_t d_idx,
...
static inline uint8_t combat_is_damage_or_firefox_launch_victim_action(uint8_t char_id,
                                                                       uint16_t action_id) {
...
static inline uint8_t combat_run_entry_collision_pose_sample_frame(
...
static inline uint8_t combat_single_create_grounded_guardreflect_enable_edge_allows_shield(
...
static inline uint8_t combat_primary_phantom_tiplog_allows_later_same_group_body(
    const MslBatch* batch, const MslCommonParams* c, int bi, int attacker, int hb_id, int defender,
    uint8_t hit_group) {
...
static inline uint8_t combat_attackairn_post_contact_dense_seed_suppresses_full_body(
    const MslBatch* batch, int bi, int attacker, int hb_id, int defender) {
  if (batch == NULL || bi < 0 || attacker < 0 || attacker >= (int)MSL_MAX_PLAYERS || hb_id < 0 ||
      hb_id >= MSL_MAX_HITBOXES || defender < 0 || defender >= (int)MSL_MAX_PLAYERS ||
      attacker == defender) {
...
static inline uint8_t combat_attackairn_guard_dense_seed_suppresses_full_body(
    const MslBatch* batch, int bi, int attacker, int hb_id, int defender, uint16_t defender_iid) {
  if (batch == NULL || bi < 0 || attacker < 0 || attacker >= (int)MSL_MAX_PLAYERS || hb_id < 0 ||
      hb_id >= MSL_MAX_HITBOXES || defender < 0 || defender >= (int)MSL_MAX_PLAYERS ||
      attacker == defender) {
...
static inline uint8_t combat_sample_active_hitlag_attackair_ecb(const MslBatch* batch, size_t idx,
...
static inline void combat_publish_damage_hitlag_ecb_points(MslBatch* batch, size_t idx,
...
static inline uint8_t combat_guardsetoff_carried_shield_packet_owner(const MslBatch* batch,
                                                                     size_t idx) {
  if (batch == NULL) {
    return 0u;
  }
...
static inline uint8_t combat_attack11_hitbox_payload_is_authored_jab(uint8_t hb_id,
                                                                     int hitcapsule_int_dmg,
                                                                     uint16_t hitbox_angle,
                                                                     uint16_t hitbox_kbg,
                                                                     uint16_t hitbox_bkb) {
...
static inline uint8_t combat_damageflyroll_wait_attacklw3_hitcapsule_owner(
    const MslBatch* batch, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, uint8_t source_cap_valid, uint16_t source_motion_id,
    int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle, uint16_t source_hitbox_kbg,
...
static inline uint8_t combat_damageflyroll_sustained_jump_late_attackairn_leg_hitcapsule_owner(
    const MslBatch* batch, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb) {
...
static inline void combat_damageflyroll_consume_sustained_jump_late_attackairn_leg_count(
    MslBatch* batch, int bi, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb) {
...
static inline uint8_t combat_damageflyroll_recovery_action_attackairlw_hitcapsule_owner(
    const MslBatch* batch, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb, uint8_t defender_on_ground_before) {
...
static inline void combat_damageflyroll_consume_recovery_action_attackairlw_count(
    MslBatch* batch, int bi, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb, uint8_t defender_on_ground_before) {
...
static inline uint8_t combat_damageflyroll_landingairn_weak_attackairb_hitcapsule_owner(
    const MslBatch* batch, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb, uint8_t defender_on_ground_before) {
...
static inline void combat_damageflyroll_consume_landingairn_weak_attackairb_count(
    MslBatch* batch, int bi, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb, uint8_t defender_on_ground_before) {
...
static inline uint8_t combat_damageflyroll_specialhifall_strong_attackairb_cap2_owner(
    const MslBatch* batch, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb) {
...
static inline void combat_damageflyroll_consume_specialhifall_strong_attackairb_count(
    MslBatch* batch, int bi, size_t d_idx, size_t a_idx, int attacker, size_t source_hb_i,
    uint8_t source_hb_valid, size_t source_cap_i, uint8_t source_cap_valid,
    uint16_t source_motion_id, int source_hitcapsule_int_dmg, uint16_t source_hitbox_angle,
    uint16_t source_hitbox_kbg, uint16_t source_hitbox_bkb) {
