...
// The flash/display half of this file is an explicit headless exclusion, but
// its ground-IK half is gameplay: fighter collision calls it to publish the
// foot-solved matrices later observed by hit and hurt capsules.
// refs/melee/src/melee/ft/fighter.c::ft_80089B08
#include "ft/types.h"
...
#else
// IKChainData is the PPC prefix of Fighter::IKState. Use the named owner when
// host pointers widen so the gameplay fields retain their source meaning.
typedef IKState IKChainData;
#endif
