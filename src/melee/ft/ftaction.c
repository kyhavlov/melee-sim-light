...
void ftAction_80071028(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    {
        if (!fp->invisible) {
            if (MSL_CMD_FIELD(cmd, spawn_gfx_0, useUnkBone)) {
                bone = fp->ft_data->x8->x12;
            } else {
                bone = MSL_CMD_FIELD(cmd, spawn_gfx_0, boneId);
            }
            use_common_bone_id =
                MSL_CMD_FIELD(cmd, spawn_gfx_0, useCommonBoneIDs);
            destroy_on_state_change =
                MSL_CMD_FIELD(cmd, spawn_gfx_0, destroyOnStateChange);

            NEXT_CMD(cmd);
            gfx_id = MSL_CMD_FIELD(cmd, spawn_gfx_1, gfxID);
            unk = MSL_CMD_FIELD(cmd, spawn_gfx_1, unkFloat);
            ...
            offset.x = 0.003906f * MSL_CMD_FIELD(cmd, spawn_gfx_2, offsetZ);
            offset.y = 0.003906f * MSL_CMD_FIELD(cmd, spawn_gfx_2, offsetY);

            NEXT_CMD(cmd);
            offset.z = 0.003906f * MSL_CMD_FIELD(cmd, spawn_gfx_3, offsetX);
            range.x = 0.003906f * MSL_CMD_FIELD(cmd, spawn_gfx_3, rangeZ);

            NEXT_CMD(cmd);
            range.y = 0.003906f * MSL_CMD_FIELD(cmd, spawn_gfx_4, rangeY);
            range.z = 0.003906f * MSL_CMD_FIELD(cmd, spawn_gfx_4, rangeX);
...
void ftAction_8007121C(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    if (ftAction_ShouldSkipUnownedHitbox(cmd) &&
        ...
        hit_group = MSL_CMD_FIELD(cmd, create_hitbox_0, hit_group);
        if (((hitbox = &fp->x914[MSL_CMD_FIELD(cmd, create_hitbox_0, id)])
        ...
        idx = MSL_CMD_FIELD(cmd, create_hitbox_0, bone);
        if (MSL_CMD_FIELD(cmd, create_hitbox_0, use_common_bone_ids)) {
            hitbox->jobj =
                fp->parts[ftParts_GetBoneIndex(
                              fp, MSL_CMD_FIELD(cmd, create_hitbox_0, bone))]
                    .joint;
        } else {
            hitbox->jobj = fp->parts[idx].joint;
        }
        ftColl_8007ABD0(hitbox, MSL_CMD_FIELD(cmd, create_hitbox_0, damage),
                        gobj);
        NEXT_CMD(cmd);
        hitbox->scale = 0.003906f * MSL_CMD_FIELD(cmd, create_hitbox_1, size);
        hitbox->b_offset.x =
            0.003906f * MSL_CMD_FIELD(cmd, create_hitbox_1, z_offset);
        NEXT_CMD(cmd);
        hitbox->b_offset.y =
            0.003906f * MSL_CMD_FIELD(cmd, create_hitbox_2, y_offset);
        hitbox->b_offset.z =
            0.003906f * MSL_CMD_FIELD(cmd, create_hitbox_2, x_offset);
        NEXT_CMD(cmd);
        ftColl_8007AC9C(hitbox, MSL_CMD_FIELD(cmd, create_hitbox_3, angle),
                        gobj);
        hitbox->x24 = MSL_CMD_FIELD(cmd, create_hitbox_3, knockback_growth);
        hitbox->x28 =
            MSL_CMD_FIELD(cmd, create_hitbox_3, weight_set_knockback);
        hitbox->x43_b0 =
            MSL_CMD_FIELD(cmd, create_hitbox_3, item_hit_interaction);
        hitbox->x43_b1 =
            MSL_CMD_FIELD(cmd, create_hitbox_3, ignore_fighter_scale);
        hitbox->x40_b0 = MSL_CMD_FIELD(cmd, create_hitbox_3, clank);
        hitbox->x40_b1 = MSL_CMD_FIELD(cmd, create_hitbox_3, rebound);
        NEXT_CMD(cmd);
        hitbox->x2C = MSL_CMD_FIELD(cmd, create_hitbox_4, base_knockback);
        hitbox->element = MSL_CMD_FIELD(cmd, create_hitbox_4, element);
        hitbox->x34 = MSL_CMD_FIELD(cmd, create_hitbox_4, shield_damage);
        hitbox->sfx_severity =
            MSL_CMD_FIELD(cmd, create_hitbox_4, hit_sfx_severity);
        hitbox->sfx_kind = MSL_CMD_FIELD(cmd, create_hitbox_4, hit_sfx_kind);
        hitbox->x40_b2 = MSL_CMD_FIELD(cmd, create_hitbox_4, hit_aerial);
        hitbox->x40_b3 = MSL_CMD_FIELD(cmd, create_hitbox_4, hit_grounded);
        NEXT_CMD(cmd);
        hitbox->x42_b5 = 1;
        hitbox->x42_b7 = 1;
        hitbox->x41_b4 = 0;
        ...
        hitbox->hit_grabbed_victim_only =
            MSL_CMD_FIELD(cmd, create_hitbox_5, x1_b4);
        hitbox->x42_b1 = 1;
        hitbox->x42_b2 = 0;
        hitbox->x43_b2 = 0;
...
{
    HitCapsule* hit =
        &GET_FIGHTER(gobj)->x914[MSL_CMD_FIELD(cmd, set_hitbox_damage, idx)];
    ftColl_8007ABD0(hit, MSL_CMD_FIELD(cmd, set_hitbox_damage, value), gobj);
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    HitCapsule* hit = &fp->x914[MSL_CMD_FIELD(cmd, set_hitbox_scale, idx)];
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    HitCapsule* hit = &fp->x914[MSL_CMD_FIELD(cmd, set_hitbox_x42_b57, idx)];
    switch (MSL_CMD_FIELD(cmd, set_hitbox_x42_b57, type)) {
    case 0:
        hit->x42_b5 = MSL_CMD_FIELD(cmd, set_hitbox_x42_b57, value);
        break;
    case 1:
        hit->x42_b7 = MSL_CMD_FIELD(cmd, set_hitbox_x42_b57, value);
        break;
    }
    NEXT_CMD(cmd);
}
...
{
    ftColl_8007AFC8(gobj, MSL_CMD_FIELD(cmd, set_throw_flags, hit_idx));
    NEXT_CMD(cmd);
}
...
void ftAction_80071820(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    switch (MSL_CMD_FIELD(cmd, set_cmd_var, idx)) {
    case 0:
        fp->cmd_vars[0] = MSL_CMD_FIELD(cmd, set_cmd_var, value);
        break;
    case 1:
        fp->cmd_vars[1] = MSL_CMD_FIELD(cmd, set_cmd_var, value);
        break;
    case 2:
        fp->cmd_vars[2] = MSL_CMD_FIELD(cmd, set_cmd_var, value);
        break;
    case 3:
        fp->cmd_vars[3] = MSL_CMD_FIELD(cmd, set_cmd_var, value);
        break;
    }
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    switch (MSL_CMD_FIELD(cmd, set_throw_flags, hit_idx)) {
    case 0:
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    switch (MSL_CMD_FIELD(cmd, set_airborne_state, state)) {
    case 0:
...
{
    ftColl_8007B62C(gobj, MSL_CMD_FIELD(cmd, set_airborne_state, state));
    NEXT_CMD(cmd);
}

void ftAction_80071A58(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ftColl_8007B0C0(gobj, MSL_CMD_FIELD(cmd, set_airborne_state, state));
    NEXT_CMD(cmd);
}
...
{
    ftColl_8007B128(gobj, MSL_CMD_FIELD(cmd, set_hurt_state, bone_idx),
                    MSL_CMD_FIELD(cmd, set_hurt_state, state));
    NEXT_CMD(cmd);
}
...
void ftAction_80071AE8(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    if (!MSL_CMD_FIELD(cmd, set_jab_combo, disabled) || fp->x197C != NULL) {
        fp->x2218_b1 = true;
    }
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    fp->x2218_b2 = MSL_CMD_FIELD(cmd, set_jab_rapid, state);
    NEXT_CMD(cmd);
}
...
void ftAction_80071B50(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    fp = GET_FIGHTER(gobj);
    behavior = MSL_CMD_FIELD(cmd, sound_effect_0, behavior);
    NEXT_CMD(cmd);
    ...
    case 5:
    case 6:
        sfx = MSL_CMD_FIELD(cmd, sound_effect_1, sfx_id);
        NEXT_CMD(cmd);
        vol = MSL_CMD_FIELD(cmd, sound_effect_2, volume);
        pan = MSL_CMD_FIELD(cmd, sound_effect_2, panning);
...
{
    ftParts_80074B0C(gobj, MSL_CMD_FIELD(cmd, set_dobj_flags, idx),
                     MSL_CMD_FIELD(cmd, set_dobj_flags, value));
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    HitCapsule* hit = &fp->xDF4[MSL_CMD_FIELD(cmd, set_throw_hitbox_0, idx)];
    ftColl_8007ABD0(hit, MSL_CMD_FIELD(cmd, set_throw_hitbox_0, damage), gobj);
    NEXT_CMD(cmd);

    ftColl_8007AC9C(hit, MSL_CMD_FIELD(cmd, set_throw_hitbox_1, unk0), gobj);
    hit->x24 = MSL_CMD_FIELD(cmd, set_throw_hitbox_1, hit_x24);
    hit->x28 = MSL_CMD_FIELD(cmd, set_throw_hitbox_1, hit_x28);
    NEXT_CMD(cmd);

    hit->x2C = MSL_CMD_FIELD(cmd, set_throw_hitbox_2, hit_x2C);
    hit->element = MSL_CMD_FIELD(cmd, set_throw_hitbox_2, element);
    hit->sfx_severity = MSL_CMD_FIELD(cmd, set_throw_hitbox_2, sfx_severity);
    hit->sfx_kind = MSL_CMD_FIELD(cmd, set_throw_hitbox_2, sfx_kind);
    NEXT_CMD(cmd);
}
...
{
    PAD_STACK(8);
    ftCommon_8007F5CC(gobj, MSL_CMD_FIELD(cmd, unk27, value));
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    fp->x221E_b4 = MSL_CMD_FIELD(cmd, set_article_vis, value);
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    fp->x221E_b5 = MSL_CMD_FIELD(cmd, set_fighter_vis, value);
    NEXT_CMD(cmd);
}
...
void ftAction_80071FC8(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    fp = GET_FIGHTER(gobj);
    volume = MSL_CMD_FIELD(cmd, pseudo_random_sfx_0, volume);
    panning = MSL_CMD_FIELD(cmd, pseudo_random_sfx_0, panning);
    behavior = MSL_CMD_FIELD(cmd, pseudo_random_sfx_0, behavior);
    rand = MSL_CMD_FIELD(cmd, pseudo_random_sfx_0, random_range);
    NEXT_CMD(cmd);
    rand = HSD_Randi(rand);
    switch (rand) {
    case 0:
        sfx_id = MSL_CMD_FIELD(cmd, pseudo_random_sfx_1, sfx_id);
        NEXT_CMD(cmd);
        NEXT_CMD(cmd);
        NEXT_CMD(cmd);
        NEXT_CMD(cmd);
...
void ftAction_80072320(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    fp = GET_FIGHTER(gobj);
    pitch_select = MSL_CMD_FIELD(cmd, stage_sfx_0, pitch_select);
    behavior = MSL_CMD_FIELD(cmd, stage_sfx_0, sfx_base);
    sfx_base = MSL_CMD_FIELD(cmd, stage_sfx_0, x2_b0_7);
    ...
    NEXT_CMD(cmd);
    sfx = ft_80087D0C(fp, MSL_CMD_FIELD(cmd, stage_sfx_1, sfx_id));
    NEXT_CMD(cmd);
    sfx_param2 = MSL_CMD_FIELD(cmd, stage_sfx_2, x2_b0_15);
    NEXT_CMD(cmd);
    sfx_param0 = MSL_CMD_FIELD(cmd, stage_sfx_3, x2_b0_7);
    sfx_param1 = MSL_CMD_FIELD(cmd, stage_sfx_3, x3_b0_7);
    NEXT_CMD(cmd);
...
{
    ftAnim_800704F0(gobj, MSL_CMD_FIELD(cmd, set_tex_anim, idx),
                    MSL_CMD_FIELD(cmd, set_tex_anim, frame));
    if (MSL_CMD_FIELD(cmd, set_tex_anim, b)) {
        ftAnim_800704F0(gobj, MSL_CMD_FIELD(cmd, set_tex_anim, idx2),
                        MSL_CMD_FIELD(cmd, set_tex_anim, frame));
    }
    NEXT_CMD(cmd);
}
...
{
    ftAnim_ApplyPartAnim(gobj, MSL_CMD_FIELD(cmd, part_anim, unk1),
                         MSL_CMD_FIELD(cmd, part_anim, unk2),
                         MSL_CMD_FIELD(cmd, part_anim, unk3));
    NEXT_CMD(cmd);
}
...
{
    ftAnim_ApplyPartAnim(gobj, MSL_CMD_FIELD(cmd, part_anim, unk1),
                         MSL_CMD_FIELD(cmd, part_anim, unk2), 0.0f);
    NEXT_CMD(cmd);
}

void ftAction_80072894(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ftCommon_8007E83C(gobj, MSL_CMD_FIELD(cmd, unk9, unk1),
                      MSL_CMD_FIELD(cmd, unk9, unk2));
    NEXT_CMD(cmd);
}
...
void ftAction_800728F8(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    if (MSL_CMD_FIELD(cmd, unk10, unk1)) {
        ftCommon_8007EC30(MSL_CMD_FIELD(cmd, unk10, unk2),
                          MSL_CMD_FIELD(cmd, unk10, unk3));
    } else {
        ftCommon_8007EBAC(fp, MSL_CMD_FIELD(cmd, unk10, unk2),
                          MSL_CMD_FIELD(cmd, unk10, unk3));
    }
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    ftCommon_8007ECD4(fp, MSL_CMD_FIELD(cmd, unk11, unk1));
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    int unk2 = MSL_CMD_FIELD(cmd, unk12, unk2);
    int unk3 = MSL_CMD_FIELD(cmd, unk12, unk3);
    switch (MSL_CMD_FIELD(cmd, unk12, unk1)) {
    case 0:
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    ftCo_800BFFD0(fp, MSL_CMD_FIELD(cmd, unk13, unk1),
...
{
    ftCo_800C0200(GET_FIGHTER(gobj), MSL_CMD_FIELD(cmd, unk14, unk1));
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    fp->x221E_b1 = MSL_CMD_FIELD(cmd, unk15, unk1);
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    fp->x2100 = MSL_CMD_FIELD(cmd, unk16, unk4);
    fp->x2101_bits_8 = MSL_CMD_FIELD(cmd, unk16, unk3);
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    ftCo_8009E318(gobj, MSL_CMD_FIELD(cmd, unk17, unk1), fp->cur_anim_frame);
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    Fighter_TakeDamage_8006CC7C(fp, MSL_CMD_FIELD(cmd, unk18, damage_amount));
    NEXT_CMD(cmd);
}
...
{
    ft_8008A1B8(gobj, MSL_CMD_FIELD(cmd, unk19, unk1));
    NEXT_CMD(cmd);
}
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    fp->x2225_b2 = MSL_CMD_FIELD(cmd, unk20, unk1);
    NEXT_CMD(cmd);
}
...
void ftAction_80072CD8(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    if (ft_80084BFC(gobj, &sp64, &sp60, &gfx_id) != false) {
        ...
        if (gfx_id != -1) {
            ...
            if (!MSL_CMD_FIELD(cmd, footstep_fx_0, use_alt_bone)) {
...
void ftAction_80072E4C(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    sp60 = 1;
    gfx_id = -1;
    cmd_flag = MSL_CMD_FIELD(cmd, unk_fx_0, x1_b0_7);
    cmd_flag &= 1;
...
void ftAction_80073008(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    charge_rate = MSL_CMD_FIELD(cmd, smash_charge_0, charge_rate);
    charge_frames = MSL_CMD_FIELD(cmd, smash_charge_0, charge_frames);
    dmg_mult = 0.003906f * charge_rate;
    NEXT_CMD(cmd);
    color_anim = MSL_CMD_FIELD(cmd, smash_charge_1, color_anim);
    NEXT_CMD(cmd);
...
{
    Fighter* fp = GET_FIGHTER(gobj);
    ftCo_800C8B60(fp, MSL_CMD_FIELD(cmd, unk21, unk1),
                  MSL_CMD_FIELD(cmd, unk21, unk2));
    NEXT_CMD(cmd);
}
...
void ftAction_80073118(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    idx = MSL_CMD_FIELD(cmd, wind_fx_0, bone);
    NEXT_CMD(cmd);

    x = 0.003906f * MSL_CMD_FIELD(cmd, wind_fx_1, timer);
    y = 0.003906f * MSL_CMD_FIELD(cmd, wind_fx_1, x);
    NEXT_CMD(cmd);

    mag = 0.003906f * MSL_CMD_FIELD(cmd, wind_fx_2, y);
    decay_amt = 0.003906f * MSL_CMD_FIELD(cmd, wind_fx_2, mag);
    NEXT_CMD(cmd);

    timer = MSL_CMD_FIELD(cmd, wind_fx_3, angle);
    angle = 0.003906f * MSL_CMD_FIELD(cmd, wind_fx_3, decay);
    NEXT_CMD(cmd);
...
void ftAction_80073240(Fighter_GObj* fighter_gobj)
{
    ...
    if (fp->x3E4_fighterCmdScript.u != NULL) {
        ...
        do {
            ...
            eventCode = MSL_CMD_OPCODE(ftCommand->u);
    ...
    if (fp->x3E4_fighterCmdScript.u != NULL) {
        ...
        do {
            ...
            }
            {
                ...
                eventCode = MSL_CMD_OPCODE(cmd->u);
...
void ftAction_8007349C(Fighter_GObj* gobj)
{
    ...
    do {
        ...
        {
            u32 id = MSL_CMD_FIELD(cmd, Command_09, id);
