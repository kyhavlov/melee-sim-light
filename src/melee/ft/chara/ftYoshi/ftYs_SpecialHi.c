...
#include <melee/it/items/ityoshieggthrow.h>
#include <melee/it/items/ityoshitongue.h>
...
void ftYs_SpecialS_8012DF8C(Fighter_GObj* gobj, Vec3* arg1)
{
    ...
    }
    {
        ...
        arg1->x = __fmadds(fp->mv.ys.specialhi.x4, da->x100, da->xFC) * cosf(angle);
        arg1->y = __fmadds(fp->mv.ys.specialhi.x4, da->x100, da->xFC) * sinf(angle);
        arg1->z = 0.0f;
    }
}
...
void fn_8012E110(Fighter_GObj* gobj)
{
    ...
    if (fp->cmd_vars[0] != 0U && fp->fv.ys.x2238 != NULL) {
        ...
        ftYs_SpecialS_8012DF8C_outline(gobj, &sp18);
        {
            ...
            it_802B28C8(fp->fv.ys.x2238, &sp18, &sp24, __fmadds(x4, da->x110, da->x10C),
                        x4);
        }
        fp->fv.ys.x2238 = NULL;
        fp->take_dmg_cb = NULL;
