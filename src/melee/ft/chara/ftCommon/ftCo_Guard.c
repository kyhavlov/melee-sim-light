...
bool ftCo_800925A4(HSD_GObj* gobj)
{
    ...
    if (fp->x221B_b0) {
        ...
        // Retail GALE01 0x80092624 is a scalar-single fmadd. Keep that
        // operation boundary explicit while this host build otherwise uses
        // -ffp-contract=off.
        fp->shield_health -=
            p_ftCommonData->x278 *
