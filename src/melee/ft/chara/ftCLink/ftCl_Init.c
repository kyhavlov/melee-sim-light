...
void ftCl_Init_OnLoad(HSD_GObj* gobj)
{
    ...
    {
        float frame_end = lbAnim_8001E8F8(ftData_80085E50(fp, 72));

        // The source derives this archive attribute during fighter load.
        // GameData preload performs the first mutation; later Match
        ...
        // refs/melee/src/melee/ft/chara/ftCLink/ftCl_Init.c::ftCl_Init_OnLoad
        if (ea->attackairlw_hit_anim_frame_end != frame_end) {
            ea->attackairlw_hit_anim_frame_end = frame_end;
        }
    }
#else
