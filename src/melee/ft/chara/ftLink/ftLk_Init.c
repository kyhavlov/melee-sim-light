...
void ftLk_Init_OnLoad(HSD_GObj* gobj)
{
...
#ifdef MSL_CORE_HOSTED
    {
        ...
        // refs/melee/src/melee/ft/chara/ftLink/ftLk_Init.c::ftLk_Init_OnLoad
        if (da->attackairlw_hit_anim_frame_end != frame_end) {
            da->attackairlw_hit_anim_frame_end = frame_end;
        }
    }
#else
