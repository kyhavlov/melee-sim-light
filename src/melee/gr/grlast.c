...
#define grNLa_804D6AD0 ((union ColorOverlay_x8_t**) Ground_801C49F8())
#else
static union ColorOverlay_x8_t** grNLa_804D6AD0;
#endif
...
static void grLast_8021AC30(Ground_GObj* gobj)
{
    ...
    gp->u.last.xCC = 0;
    gp->u.last.xD0 = 0;
    gp->u.last.xD4 = __fmadds(grLast_804DBB80, HSD_Randf(), grLast_804DBB7C);
    gp->u.last.xD4 *= HSD_Randi(2) ? +1.0F : -1.0F;
    gp->u.last.xD8 = __fmadds(grLast_804DBB80, HSD_Randf(), grLast_804DBB7C);
...
static void grLast_8021ADD0(Ground_GObj* gobj)
{
    ...
    if (gp->u.last.xC4 > grLast_804DBB94) {
        ...
        randf = HSD_Randf();
        gp->u.last.xD4 = __fmsubs(grLast_804DBB80, -randf, grLast_804DBB7C);
    ...
    if (gp->u.last.xC8 > grLast_804DBB9C) {
        ...
        randf = HSD_Randf();
        gp->u.last.xD8 = __fmsubs(grLast_804DBB80, -randf, grLast_804DBB7C);
...
static void grLast_8021B2E8(Ground_GObj* gobj)
{
    ...
    gp = GET_GROUND(gobj);
#ifndef MSL_CORE_HOSTED
    // Boss/event damage progression is outside the supported versus stages.
