...
HSD_GObj* grOldPupupu_802108B4(int arg0)
{
    ...
    if (gobj != NULL) {
        ...
        OSReport((char*) grOp_803E6688 + 0xF4, (char*) grOp_803E6688 + 0x118,
                 0xD9, arg0);
#else
        // The omitted id=2 cloud model is presentation-only. Its source
        // spawn attempt remains a harmless NULL result headlessly.
        // refs/melee/src/melee/gr/groldpupupu.c::grOldPupupu_80210D10
#endif
    }
...
publish_direction:
    ...
    {
        u8 direction;
        // SendDreamlandInfo.asm records xDC at the callback epilogue,
        // 0x80211BF8, before fighter priority-4 physics consumes the wind.
        // Keep the source timer/animation/RNG machine running in playback.
