...
typedef struct MslPythonControllerInput {
  MslPythonControllerPlayer p[MSL_MAX_PLAYERS];
} MslPythonControllerInput;
#pragma pack(pop)

MSL_PYTHON_API int msl_python_controller_inputs(const MslPythonControllerInput* source,
                                                size_t source_stride, MslInput* output,
