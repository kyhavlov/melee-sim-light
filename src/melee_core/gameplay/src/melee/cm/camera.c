...
void Camera_8002A0C0(CameraBounds* bounds, CameraTransformState* state)
{
    ...
    viewport_x_scale =
        ...
        (half_view_height /
         (0.5f *
          (f32) (cm_803BCB64.viewport.xmax - cm_803BCB64.viewport.xmin)));
    viewport_y_scale =
        half_view_height /
        (0.5f *
         (f32) (cm_803BCB64.viewport.ymax - cm_803BCB64.viewport.ymin));
