...
enum {
    ...
    MSL_CORE_ITEM_KIND_PICHU_THUNDER = 82,
    MSL_CORE_ITEM_KIND_PICHU_TJOLT_GROUND = 91,
    MSL_CORE_ITEM_KIND_PICHU_TJOLT_AIR = 92,
                                                       ...
                                                       uint8_t state)
{
    ...
    case MSL_CORE_ITEM_KIND_PICHU_TJOLT_GROUND:
    ...
    case MSL_CORE_ITEM_KIND_PICHU_TJOLT_AIR:
