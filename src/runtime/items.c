...
struct sdata_ItemGXLink it_803F2F28[118] = {
    ...
    [It_Kind_Kirby_CBeam - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_Hammer - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Unk1 - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Unk2 - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_MarioFire - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_DrMarioVitamin - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_LuigiFire - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_IceClimberIce - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_PeachToad - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_PeachToadSpore - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_FoxLaser - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_FalcoLaser - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_FoxBlaster - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_FalcoBlaster - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_LinkArrow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_CLinkArrow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_LinkBow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_CLinkBow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_MewtwoShadowBall - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_NessPKFlush - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_NessPKFlush_Explode - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_PikachuTJolt_Ground - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_PikachuTJolt_Air - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_PichuTJolt_Ground - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_PichuTJolt_Air - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_SamusCharge - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_SeakNeedleThrow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_SeakNeedleHeld - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_KoopaFlame - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_GameWatchChef - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_GameWatchChefPan - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Kirby_YoshiEggLay - It_Kind_Kuriboh] = { NULL },
};
...
struct ItemLogicTable it_803F3100[118] = {
    ...
    // Kirby's own items and every copy-ability projectile. The copied rows
    // are upstream's, which reuse the original fighters' logic tables.
    // refs/melee/src/melee/it/it_279C.c
    [It_Kind_Kirby_CBeam - It_Kind_Kuriboh] = {
        // Kirby cutter beam
        it_803F6798,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_Hammer - It_Kind_Kuriboh] = {
        // Kirby hammer
        it_803F6C98,
        NULL,
    ...
    [It_Kind_Unk1 - It_Kind_Kuriboh] = {
        // Kirby copy-ability drop star (taunt / hat loss).
        // refs/melee/src/melee/it/items/it_2ADA.c
        it_803F6C88,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Unk2 - It_Kind_Kuriboh] = {
        // Kirby swallow spit star.
        // refs/melee/src/melee/it/items/it_2F28.c
        it_803F9470,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_MarioFire - It_Kind_Kuriboh] = {
        it_803F6788,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_DrMarioVitamin - It_Kind_Kuriboh] = {
        it_803F75D0,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_LuigiFire - It_Kind_Kuriboh] = {
        it_803F75C0,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_IceClimberIce - It_Kind_Kuriboh] = {
        it_803F7668,
        NULL,
        it_2725_Logic90_Destroyed,
        NULL,
    ...
    [It_Kind_Kirby_PeachToad - It_Kind_Kuriboh] = {
        it_803F7528,
        NULL,
        itPeachToad_Logic91_Destroyed,
        itPeachToad_Logic91_PickedUp,
    ...
    [It_Kind_Kirby_PeachToadSpore - It_Kind_Kuriboh] = {
        it_803F7548,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_FoxLaser - It_Kind_Kuriboh] = {
        it_803F67D0,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_FalcoLaser - It_Kind_Kuriboh] = {
        it_803F67D0,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_FoxBlaster - It_Kind_Kuriboh] = {
        it_803F6CA8,
        NULL,
        NULL,
        itFoxBlaster_Logic96_PickedUp,
    ...
    [It_Kind_Kirby_FalcoBlaster - It_Kind_Kuriboh] = {
        it_803F6CA8,
        NULL,
        NULL,
        itFoxBlaster_Logic96_PickedUp,
    ...
    [It_Kind_Kirby_LinkArrow - It_Kind_Kuriboh] = {
        it_803F6A28,
        NULL,
        itLinkArrow_Logic98_Destroyed,
        itLinkArrow_Logic98_PickedUp,
    ...
    [It_Kind_Kirby_CLinkArrow - It_Kind_Kuriboh] = {
        it_803F6A28,
        NULL,
        itLinkArrow_Logic98_Destroyed,
        itLinkArrow_Logic98_PickedUp,
    ...
    [It_Kind_Kirby_LinkBow - It_Kind_Kuriboh] = {
        it_803F6E98,
        NULL,
        itLinkBow_Logic100_Destroyed,
        itLinkBow_Logic100_PickedUp,
    ...
    [It_Kind_Kirby_CLinkBow - It_Kind_Kuriboh] = {
        it_803F6E98,
        NULL,
        itLinkBow_Logic100_Destroyed,
        itLinkBow_Logic100_PickedUp,
    ...
    [It_Kind_Kirby_MewtwoShadowBall - It_Kind_Kuriboh] = {
        it_803F7760,
        NULL,
        it_2725_Logic101_Destroyed,
        it_2725_Logic101_PickedUp,
    ...
    [It_Kind_Kirby_NessPKFlush - It_Kind_Kuriboh] = {
        it_803F6B70,
        NULL,
        it_2725_Logic102_Destroyed,
        NULL,
    ...
    [It_Kind_Kirby_NessPKFlush_Explode - It_Kind_Kuriboh] = {
        it_803F6F40,
        NULL,
        it_2725_Logic103_Destroyed,
        NULL,
    ...
    [It_Kind_Kirby_PikachuTJolt_Ground - It_Kind_Kuriboh] = {
        it_803F7190,
        NULL,
        it_2725_Logic106_Destroyed,
        NULL,
    ...
    [It_Kind_Kirby_PikachuTJolt_Air - It_Kind_Kuriboh] = {
        it_803F71D8,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_PichuTJolt_Ground - It_Kind_Kuriboh] = {
        it_803F7190,
        NULL,
        it_2725_Logic106_Destroyed,
        NULL,
    ...
    [It_Kind_Kirby_PichuTJolt_Air - It_Kind_Kuriboh] = {
        it_803F71D8,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_SamusCharge - It_Kind_Kuriboh] = {
        it_803F7288,
        NULL,
        it_2725_Logic108_Destroyed,
        it_2725_Logic108_PickedUp,
    ...
    [It_Kind_Kirby_SeakNeedleThrow - It_Kind_Kuriboh] = {
        it_803F6F50,
        NULL,
        itSeakNeedleThrown_Logic109_Destroyed,
        NULL,
    ...
    [It_Kind_Kirby_SeakNeedleHeld - It_Kind_Kuriboh] = {
        it_803F70A8,
        NULL,
        NULL,
        itSeakNeedleHeld_Logic110_PickedUp,
    ...
    [It_Kind_Kirby_KoopaFlame - It_Kind_Kuriboh] = {
        ItemStateTable_KoopaFlame,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_GameWatchChef - It_Kind_Kuriboh] = {
        it_803F79E0,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Kirby_GameWatchChefPan - It_Kind_Kuriboh] = {
        it_803F7958,
        NULL,
    ...
    [It_Kind_Kirby_YoshiEggLay - It_Kind_Kuriboh] = {
        it_803F94A0,
        NULL,
        NULL,
        NULL,
