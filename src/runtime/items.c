...
struct sdata_ItemGXLink it_803F2F28[118] = {
    ...
    [It_Kind_Pichu_Thunder - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Pikachu_TJolt_Ground - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Pikachu_TJolt_Air - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Pichu_TJolt_Ground - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Pichu_TJolt_Air - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKFire - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKFire_Flame - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKFlush - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKThunder - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKThunder1 - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKThunder2 - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKThunder3 - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKThunder4 - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_PKFlush_Explode - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_Bat - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Ness_Yoyo - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Link_Bomb - It_Kind_Kuriboh] = { NULL },
    [It_Kind_CLink_Bomb - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Link_Boomerang - It_Kind_Kuriboh] = { NULL },
    [It_Kind_CLink_Boomerang - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Link_HShot - It_Kind_Kuriboh] = { NULL },
    [It_Kind_CLink_HShot - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Link_Arrow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_CLink_Arrow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_Link_Bow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_CLink_Bow - It_Kind_Kuriboh] = { NULL },
    [It_Kind_CLink_Milk - It_Kind_Kuriboh] = { NULL },
...
struct ItemLogicTable it_803F3100[118] = {
    ...
    [It_Kind_GameWatch_Greenhouse - It_Kind_Kuriboh] = {
        it_803F7898,
        NULL,
    ...
    [It_Kind_GameWatch_Manhole - It_Kind_Kuriboh] = {
        it_803F78D8,
        NULL,
    ...
    [It_Kind_GameWatch_Fire - It_Kind_Kuriboh] = {
        it_803F78E8,
        NULL,
    ...
    [It_Kind_GameWatch_Parachute - It_Kind_Kuriboh] = {
        it_803F78F8,
        NULL,
    ...
    [It_Kind_GameWatch_Turtle - It_Kind_Kuriboh] = {
        it_803F7918,
        NULL,
    ...
    [It_Kind_GameWatch_Breath - It_Kind_Kuriboh] = {
        it_803F7938,
        NULL,
    ...
    [It_Kind_GameWatch_Judge - It_Kind_Kuriboh] = {
        it_803F7968,
        NULL,
    ...
    [It_Kind_GameWatch_Panic - It_Kind_Kuriboh] = {
        it_803F79A0,
        NULL,
    ...
    [It_Kind_GameWatch_Rescue - It_Kind_Kuriboh] = {
        it_803F79C0,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_GameWatch_Chef - It_Kind_Kuriboh] = {
        it_803F79E0,
        NULL,
        NULL,
        NULL,
    ...
    // Pichu's Thunder shares Pikachu's logic row (refs/melee/src/melee/it/it_279C.c).
    [It_Kind_Pichu_Thunder - It_Kind_Kuriboh] = {
        it_803F70C8,
        NULL,
        it_2725_Logic39_Destroyed,
        NULL,
    ...
    // Pichu's jolts share Pikachu's logic rows (refs/melee/src/melee/it/it_279C.c).
    [It_Kind_Pichu_TJolt_Ground - It_Kind_Kuriboh] = {
        it_803F7190,
        NULL,
        it_2725_Logic106_Destroyed,
        NULL,
    ...
    [It_Kind_Pichu_TJolt_Air - It_Kind_Kuriboh] = {
        it_803F71D8,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Link_Bomb - It_Kind_Kuriboh] = {
        it_803F6888,
        NULL,
        NULL,
        it_8029DEB0,
    ...
    [It_Kind_CLink_Bomb - It_Kind_Kuriboh] = {
        it_803F6888,
        NULL,
        NULL,
        it_8029DEB0,
    ...
    [It_Kind_Link_Boomerang - It_Kind_Kuriboh] = {
        it_803F6920,
        NULL,
    ...
    [It_Kind_CLink_Boomerang - It_Kind_Kuriboh] = {
        it_803F6920,
        NULL,
        itLinkBoomerang_Logic18_Destroyed,
        it_802A0E70,
    ...
    [It_Kind_Link_HShot - It_Kind_Kuriboh] = {
        it_803F6998,
        it_802A2418,
        NULL,
    ...
    // Retail's Young Link hookshot row carries NULL in the second slot where
    // Link's carries it_802A2418; the asymmetry is source data.
    [It_Kind_CLink_HShot - It_Kind_Kuriboh] = {
        it_803F6998,
        NULL,
        NULL,
        itLinkHookshot_Logic20_PickedUp,
    ...
    [It_Kind_Link_Arrow - It_Kind_Kuriboh] = {
        it_803F6A28,
        NULL,
    ...
    [It_Kind_CLink_Arrow - It_Kind_Kuriboh] = {
        it_803F6A28,
        NULL,
        itLinkArrow_Logic98_Destroyed,
        itLinkArrow_Logic98_PickedUp,
    ...
    [It_Kind_Link_Bow - It_Kind_Kuriboh] = {
        it_803F6E98,
        NULL,
    ...
    [It_Kind_CLink_Bow - It_Kind_Kuriboh] = {
        it_803F6E98,
        NULL,
        itLinkBow_Logic100_Destroyed,
        itLinkBow_Logic100_PickedUp,
    ...
    [It_Kind_CLink_Milk - It_Kind_Kuriboh] = {
        it_803F7A28,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_PKFire - It_Kind_Kuriboh] = {
        it_803F6B28,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_PKFire_Flame - It_Kind_Kuriboh] = {
        it_803F6B60,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_PKFlush - It_Kind_Kuriboh] = {
        it_803F6B70,
        NULL,
    ...
    [It_Kind_Ness_PKThunder - It_Kind_Kuriboh] = {
        it_803F6BC8,
        NULL,
        it_802AB90C,
        NULL,
    ...
    [It_Kind_Ness_PKThunder1 - It_Kind_Kuriboh] = {
        it_803F6C08,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_PKThunder2 - It_Kind_Kuriboh] = {
        it_803F6C08,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_PKThunder3 - It_Kind_Kuriboh] = {
        it_803F6C08,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_PKThunder4 - It_Kind_Kuriboh] = {
        it_803F6C08,
        NULL,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_PKFlush_Explode - It_Kind_Kuriboh] = {
        it_803F6F40,
        NULL,
    ...
    [It_Kind_Ness_Bat - It_Kind_Kuriboh] = {
        it_803F6C68,
        NULL,
        NULL,
    ...
    [It_Kind_Ness_Yoyo - It_Kind_Kuriboh] = {
        it_803F7558,
        NULL,
        NULL,
