...
typedef struct MslCoreGameData {
    ...
    // MSLPART1 closes every gameplay-consumed fighter joint over its
    // ancestors. tools/data/gameplay_parts.json is the audited source-owner
    // manifest; missing metadata retains the complete source JObj graph.
