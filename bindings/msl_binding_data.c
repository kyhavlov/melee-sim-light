...
PyObject* msl_char_params_part_anchors_py(PyObject* self, PyObject* args) {
  ...
  PyObject* out = Py_BuildValue(
      "{s:N,s:i,s:i,s:i,s:i,s:i,s:f,s:f}", "ecb_joints", ecb, "laser_spawn_joint_part_id",
      ...
      "escapeair_carried_floor_wall_source", (int)ch->escapeair_carried_floor_wall_source,
      "static_x1a70_y", (double)ch->static_x1a70_y, "static_x1a70_z", (double)ch->static_x1a70_z);
  return out;
}
